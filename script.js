const business = {
  ...
  phone: "919845422527",
  phoneDisplay: "+91 98454 22527",
  email: "bangalorekitchenequipment@gmail.com",
  address: "No 13, 2nd Cross, Mariyappa Circle, Mariyappa Complex, Ganapathy Nagar, Bengaluru, Karnataka 560058",
};

const image = {
  singleBurner: "/assets/products/single-burner-commercial-gas-stove-bangalore.png",
  twoBurner: "/assets/products/double-burner-commercial-gas-stove-bangalore.png",
  threeBurner: "/assets/products/industrial-three-burner-cooking-range-bangalore.jpg",
  fourBurner: "/assets/products/commercial-gas-range-clean-bangalore.webp",
  sixBurner: "/assets/products/commercial-gas-range-clean-bangalore.webp",
...
function product(name, category, imageUrl, description, alt = `${name} for commercial kitchen in Bangalore`) {
  return {
    name,
    category,
    image: imageUrl,
...
const products = [
  product("Single Burner Commercial Gas Stove", "Cooking Equipment", image.singleBurner, "Heavy-duty single-burner stainless steel commercial gas stove for compact restaurant, cafe and canteen kitchens.", "Single burner commercial gas stove in stainless steel for restaurant, cafe and canteen kitchens in Bangalore"),
  product("Double Burner Commercial Gas Stove", "Cooking Equipment", image.twoBurner, "Heavy-duty double-burner stainless steel commercial gas stove for restaurants, cafes and canteens.", "Double burner commercial gas stove in stainless steel for restaurant, hotel and canteen kitchens in Bangalore"),
  product("Industrial 3 Burner Cooking Range", "Cooking Equipment", image.threeBurner, "Heavy-duty stainless steel industrial three-burner cooking range for restaurants, hotels, canteens and commercial kitchens.", "Industrial 3 burner cooking range in stainless steel for restaurant, hotel and canteen kitchens in Bangalore"),
...
const galleryItems = [
  ["industrial-three-burner-cooking-range-bangalore.jpg", "Industrial 3 burner cooking range in Bangalore"],
  ["single-burner-commercial-gas-stove-bangalore.png", "Single burner commercial gas stove in Bangalore"],
  ["double-burner-commercial-gas-stove-bangalore.png", "Double burner commercial gas stove in Bangalore"],
